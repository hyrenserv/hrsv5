...
INSERT INTO component_menu(menu_id, menu_path, user_type, menu_name, comp_id, menu_remark) VALUES (204, '/autonomousAnalysisManage', '25', '自主分析管理', 'B000', 'el-icon-news');
INSERT INTO component_menu(menu_id, menu_path, user_type, menu_name, comp_id, menu_remark) VALUES (205, '/streamDataManagement', '18', '流数据管理', 'J000', 'el-icon-c-scale-to-original');
-- operator
...
INSERT INTO component_menu(menu_id, menu_path, user_type, menu_name, comp_id, menu_remark) VALUES (113, '/autonomousAnalysisOperate', '26', '自主分析操作', 'L001', 'el-icon-s-operation');
INSERT INTO component_menu(menu_id, menu_path, user_type, menu_name, comp_id, menu_remark) VALUES (114, '/streamDataOperation', '19', '流数据操作', 'J000', 'el-icon-c-scale-to-original');
...
INSERT INTO sys_user(user_id, create_id, dep_id, role_id, user_name, user_password, user_email,user_mobile,useris_admin, user_type, usertype_group, login_ip, login_date, user_state, create_date,create_time,update_date, update_time, user_remark, token, valid_time) VALUES ('1001', '1000','1000000001', '1001', '全功能管理员', '1', 'ccc@vv.com', '1234567890','0','01', '01,04,11,18,25,37', null, null, '1', '99991231', '000000', '', '', '系统管理员','0', '0');
INSERT INTO sys_user(user_id, create_id, dep_id, role_id, user_name, user_password, user_email,user_mobile,useris_admin, user_type, usertype_group, login_ip, login_date, user_state, create_date,create_time, update_date, update_time, user_remark, token, valid_time) VALUES ('2001', '1000','1000000001', '1001', '全功能操作员', '1', 'ccc@vv.com', '1234567890','0','02', '02,04,12,14,19,24,26,27,55', null, null, '1', '99991231', '000000', '', '', '系统操作员', '0', '0');
